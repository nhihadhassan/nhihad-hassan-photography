...
export const journalPosts: JournalPost[] = [
  {
    ...
    published: true,
    body: [
      "Finding a photogenic spot in Toronto isn't the problem. The harder question is which ones give you genuine light, room to move, and something to look at that doesn't feel like every other engagement photo from the last five years.",
      ...
      "**The Distillery District.** The brick and cobblestone read well in late-afternoon light. Winter is underrated here. Quieter crowds, and the warm tones of the brick hold even when the temperature doesn't. Avoid weekends in December unless you want Santa Claus Market crowds in your background.",
      "**Trinity Bellwoods.** Best in fall. The trees turn late and stay colourful longer than you'd expect. It's a lived-in park rather than a formal garden, which gives photos a different energy, more candid and less posed.",
      ...
      "If none of these fit, or if you have a spot that means something to you personally, bring it up when you inquire. I'd rather shoot somewhere that matters to you than default to whatever's closest.",
    ],
  },
  {
    ...
    body: [
      ...
      "**Coordinate, don't match.** Identical outfits draw attention to themselves. Clothes that work together in tone and colour let the focus stay on you. Think the same palette, not the same outfit.",
      "**Avoid busy patterns.** Fine stripes, small checks, graphic prints all compress strangely in photos and pull the eye away from faces. Solid colours or subtle textures are more reliable.",
      ...
      "**Footwear counts.** Especially for full-length shots. If we're in a park, you may be walking on grass and gravel, so plan accordingly.",
  ...
  },
  {
    ...
    body: [
      ...
      "**After the shoot.** I cull the take first, cutting duplicates, missed focus, and anything where the light or composition isn't working. What you get is a selection, not everything I shot.",
