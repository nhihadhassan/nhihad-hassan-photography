    ...
    <footer className="border-t border-soft-white/10 bg-ink px-4 py-10 text-soft-white sm:px-6 lg:px-8">
      <div className="mx-auto grid max-w-7xl gap-8 md:grid-cols-[1fr_auto] md:items-end">
        <div>
          ...
          />
          <p className="mt-5 max-w-xl text-sm leading-6 text-soft-white/60">{settings.tagline}</p>
        </div>
      ...
      <div className="mx-auto mt-10 flex max-w-7xl flex-col gap-4 text-xs text-soft-white/60 sm:flex-row sm:items-center sm:justify-between">
        <p>Copyright {brandConfig.copyrightYear} {settings.brandName}.</p>
