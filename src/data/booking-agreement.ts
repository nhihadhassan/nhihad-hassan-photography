...
export const agreementSections: AgreementSection[] = [
  ...
  },
  {
    ...
    clauses: [
      ...
      "2.3 Invoice. The Photographer will issue an invoice when the Services are agreed. The Client will pay all outstanding Fees on or before the due dates shown above, and in any event before delivery of any Images. Payment may be made by Interac e-Transfer to nhihadhassanphotography@gmail.com, or by cash. A payment made after its due date will incur a late fee of 2% per month on the outstanding balance, subject to applicable law. The final invoice may include additional services or reasonable expenses authorized under this Agreement and will state the final amount payable.",
      "2.4 Additional charges. No items are billed separately from the base package. The Total Fee is all inclusive of travel within the area described in section 3.2, parking, and equipment. No other additional charge will be incurred without the Client's approval, except where this Agreement expressly provides otherwise.",
      "2.5 Additional time. The Photographer may continue for up to 30 minutes beyond the scheduled end of coverage where needed for normal session flow, without an automatic charge. Any further coverage and its price must be discussed and approved before that coverage continues.",
    ],
  },
  {
  ...
  },
  {
    ...
    clauses: [
      ...
      "9.6 Safety. The Photographer may pause or end coverage if conditions are unsafe, unlawful, abusive, threatening, or present an unreasonable risk to any person or equipment.",
    ],
  },
  {
    heading: "10. General",
