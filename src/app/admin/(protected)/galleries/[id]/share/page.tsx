    ...
    <div className="mx-auto max-w-5xl">
      ...
      <div className="mt-6 flex items-start gap-3">
        <div className="flex size-10 shrink-0 items-center justify-center rounded-md bg-admin-copper/15">
          <Share2 className="size-5 text-admin-accent" aria-hidden="true" />
        </div>
        <div>
          <p className="text-sm font-medium text-admin-accent">Share links</p>
          <h1 className="mt-1 text-2xl font-semibold tracking-tight">{gallery.title}</h1>
          <p className="mt-1 max-w-2xl text-sm leading-6 text-admin-ink/60">
